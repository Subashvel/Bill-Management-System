...
def Total():
    ...
    entry_total = Entry(f2, font=('a ', 20, 'bold'), textvariable=Total_bill, bd=6, width=15, bg="lightgreen")
...
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Eggs........Rs.70/plate",fg="black",bg="lightgreen").place(x=10,y=260)
...
lb1_pancakes=Label(f1,font=("aria", 20, 'bold'), text="Pancakes", width=12, fg="blue4")
